class JogoDaMemoria {
    ...
    constructor({tela, util}) {
        ...
        this.heroisIniciais = [
            { img: './arquivos/amy.png', nome: 'amy' },
            { img: './arquivos/batman.png', nome: 'batman' },
            { img: './arquivos/bowie.png', nome: 'bowie' },
            { img: './arquivos/farao.png', nome: 'farao' },
            { img: './arquivos/juiza.png', nome: 'juiza' },
            { img: './arquivos/ninja.png', nome: 'ninja' }
        ]
    ...
    esconderHerois(herois) {
        ...
        // como fizemos no constrtor, vamos extrair somente o necessario
        // usando a sintaxe ({  chave: 1 }) estamos falando que 
        // vamos retornar o que tiver dentro dos parenteses
    ...
    verificarSelecao(id, nome) {
        const item = { id, nome }
        // vamos verificar a quantidade de herois selecionados e tomar ação
        // se escolheu certo ou errado
        ...
        switch(heroisSelecionados) {
            case 0:
                ...
                break;
            case 1:
                // se a quantidade de escolhidos for 1, significa que o usuario
                // só pode escolher mais um e vamos obter o primeiro item da lista
                const [ opcao1 ] = this.heroisSelecionados
                // zerar itens para não selecionar mais de dois
                this.heroisSelecionados = []
                // conferimos se os nomes e ids batem conforme o esperado
                if(opcao1.nome === item.nome && 
                 // aqui verificamos se são ids diferentes para o usuario
